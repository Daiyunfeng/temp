...
<link href="res/umeditor/themes/default/css/umeditor.css"
	type="text/css" rel="stylesheet">
<script type="text/javascript" src="res/js/jquery.min.js"></script>
<script type="text/javascript" src="res/umeditor/umeditor.config.js"></script>
<script type="text/javascript" src="res/umeditor/umeditor.js"></script>
<script type="text/javascript" src="res/umeditor/lang/zh-cn/zh-cn.js"></script>
<script type="text/javascript" src="res/js/index.js"></script>
</head>
<body>
	<div>
		<textarea id="myEditor" style="width: 1000px; height: 240px;"></textarea>
	</div>
	<div class="clear"></div>
	<div id="btns">
		<table>
